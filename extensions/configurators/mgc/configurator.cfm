...
<cfoutput>
	...
	<div id="availableObjectParams"	
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="##tabBasic" data-toggle="tab">Basic Settings</a></li>
			<li><a href="##tabAdvanced" data-toggle="tab">Advanced</a></li>
		</ul>
		...
		<div class="fieldset-wrap row-fluid">
			<div class="tab-content">
				...
				<!--- BASIC --->
				<div id="tabBasic" class="fieldset tab-pane active">
				...
				<!--- ADVANCED --->
				<div id="tabAdvanced" class="fieldset tab-pane">
